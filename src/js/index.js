...
// const searchInputCard = document.querySelector('input[name="searchQuery"');
// const searchFormCard = document.getElementById('search-form');
...
//           e.preventDefault();
//           options.params.q = searchInputCard.value.trim();
//           if (options.params.q === '') {
//             return;
//           }
...
//               renderGallery(hits);
//             }
//             searchInputCard.value = '';
//           } catch (err) {
//             Notify.failure(err);
//           }
//         }
        
//         searchFormCard.addEventListener('submit', handleSubmit);
